...
Add item to the bill using only the bar code as a parameter
 - Items added one by one, multiple calls as it only takes the bar code
Remove the item from the bill using only the bar code as parameter
 -Again multiple removals require multiple calls
A summary of the bill, looking like :
